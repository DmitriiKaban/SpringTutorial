...
public class PersonDAO {
    ...
    public void testMultipleUpdate() {
        ...
        System.out.println("Time to insert 1000 object: " + (after - before));
    }
    ...
    public void testBatchUpdate() {
        ...
        // makes DB insertions to be treated in multiple threads
        ...
        long after = System.currentTimeMillis();
        System.out.println("Time to insert 1000 objects: " + (after - before));
    }
